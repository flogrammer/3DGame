...
Möchte man der Welt neben ein paar Modellen außerdem eine realistische Umgebung geben, so darf man den Himmel nicht vergessen. Auch hier hat die jMonkeyEngine vorgefertigte Libraries und in dem SceneComposer ist es relativ einfach, einen geeigneten Himmel zu erstellen. Nach einer kleinen Suche im Internet findet man schnell einen passenden Himmel, welchen man gegebenenfalls auch selbst erstellen kann. Ein Himmel besteht immer aus verschiedenen Bildern, welche die einzelnen Richtungen ausmachen. Hier ein Beispiel:  
